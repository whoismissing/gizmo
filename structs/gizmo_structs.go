...
/*
This interface is used to describe a service check. All service
checks need to implement the CheckHealth() method
*/
type ServiceCheck interface {
    CheckHealth(service *Service, wg *sync.WaitGroup)
}

/* BEGIN - structs that implement the ServiceCheck interface */
...
/* END - structs that implement the ServiceCheck interface */

/*
Update the check count of a service given the uptime status
*/
...
/*
Iterate over all services of a team and update a team's check count
based on the statuses of those services
*/
...
/* BEGIN - implementations of the CheckHealth() method */
...
/* END - implementations of the CheckHealth() method */
