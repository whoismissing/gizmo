...
/*
Obtain the GameID from the database
and insert a specified team
*/
...
/*
Obtain the highest ServiceID from the database
then insert a specified service into the database
with the ServiceID incremented by one
*/
...
/*
Insert the specified service structure into the database
*/
...
/*
Insert all specified services from a list into the database
*/
...
/*
Insert the specified team structure into the database
*/
...
/*
Insert all specified teams from a list into the database
*/
...
/*
Insert the specified game structure into the database
*/
...
/*
Obtain the GameStartTime from the database
and update the specified Game structure 
*/
...
/*
Obtain the TotalMissedChecks and TotalChecks based on TeamID from the
database and update the corresponding Team structure

If the specified team structure is NOT found in the database, INSERT
...
/*
Obtain the NumberOfMissedChecks and NumberOfChecks based on service Name from
the database and update the corresponding Service structure

If the specified service structure is NOT found in the database, INSERT
it into the database
*/
...
/*
For all teams in the game, load values from the database
and insert any unknowns into the database otherwise
*/
